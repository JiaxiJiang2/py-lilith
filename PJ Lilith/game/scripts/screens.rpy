...
screen main_menu():
    ...
    # 🆕 如果已通关，在下方显示达成信息
    if persistent.end1_unlocked:
        text "已达成 END1" xpos 0.5 ypos 0.95 xanchor 0.5 size 24 color "#ffffff" outlines [(1, "#000000")]

    if persistent.end1_unlocked:
        text "已达成 END2" xpos 0.5 ypos 0.95 xanchor 0.5 size 24 color "#ffffff" outlines [(1, "#000000")]
